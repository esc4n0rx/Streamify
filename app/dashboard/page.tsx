...
const TRENDING_CONTENT = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1596727147705-61a532a659bd?w=800&q=80",
    category: "Sci-Fi",
    rating: 4.8,
  },
  {
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      {/* Exibe o ProfileSelector somente se tivermos os dados do usuário */}
          ...
          >
            ...
            >
              ...
              <span className="text-lg font-semibold">
                {TRENDING_CONTENT[0].rating}
              </span>
              <span className="text-gray-400">
                • {TRENDING_CONTENT[0].category}
              </span>
            </motion.div>
